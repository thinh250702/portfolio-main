...
export default class BrandGen {
  ...
  createTimeline() {
    ...
    .from(this.dom.shimmerText, { opacity: 0, duration: this.options.duration, ease: this.options.ease}, "+=0.5")
    .from(this.dom.shimmerImg, { scale: 0, duration: this.options.duration, ease: this.options.ease}, "<")
    .to(this.dom.shimmerText, { opacity: 0, duration: this.options.duration, ease: this.options.ease}, "+=3")
